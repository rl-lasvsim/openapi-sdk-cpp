...
namespace lasvsim
{
    ...
    public:
        StepCode code;
        std::string message;
        StepRes(StepCode code, std::string message) : code(code), message(std::move(message)) {}
    };
    ...
    public:
        ...
        Position(const std::string &junction_id,
            ...
            : junction_id(junction_id),
              ...
              type(type),
              s(s),
              dis_to_lane_end(dis_to_lane_end),
              t(t),
              heading(heading),
              lane_id(lane_id),
              lane_index(lane_index),
              point(point), // 这里正确初始化 point
              roll(roll),
